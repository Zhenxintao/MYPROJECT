...
public class TransFormBolt extends BaseBasicBolt implements Ibolt {
    Logger LOGGER = LoggerFactory.getLogger(TransFormBolt.class);
    public final int boltId=324432432;
    public final String boltName="transform";
    ...
    public void execute(Tuple tuple, BasicOutputCollector basicOutputCollector) {
        DataStream ds=(DataStream) tuple.getValueByField("transform");
        LOGGER.info("transformBolt处理器获得数据：name={},type={}",ds.getName(),ds.getType());
    ...
    public void declareOutputFields(OutputFieldsDeclarer outputFieldsDeclarer) {
        outputFieldsDeclarer.declare(new Fields("export"));
    }
}
