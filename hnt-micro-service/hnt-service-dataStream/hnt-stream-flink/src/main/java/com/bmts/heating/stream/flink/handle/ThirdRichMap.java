...
public class ThirdRichMap extends RichMapFunction<Message_Gather, Message_Gather> {

    private static Logger logger = LoggerFactory.getLogger(ThirdRichMap.class);
...
//        super.open(parameters);
    ...
    public Message_Gather map(Message_Gather messageGather) throws Exception {
        logger.info("============Third 接收对象数据----- {}", messageGather.getRelevanceId());
