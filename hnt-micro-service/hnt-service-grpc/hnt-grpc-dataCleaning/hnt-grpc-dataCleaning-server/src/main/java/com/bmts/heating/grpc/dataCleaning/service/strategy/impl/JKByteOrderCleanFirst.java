 ...
 */
@Component
@Clean(cleanType = DataCleanType.BYTE_ORDER_BIG_TO_LITTLE)
public class JKByteOrderCleanFirst implements DataCleanStrategy<PointL> {
    ...
    public PointL dataClean(PointL pointL) {
        ...
        if (!StringUtils.isEmpty(oldStr) && !Objects.equals("\"\"", oldStr)) {
            ...
            String newStr = ByteOrderUtil.bigToLittle(oldStr);
