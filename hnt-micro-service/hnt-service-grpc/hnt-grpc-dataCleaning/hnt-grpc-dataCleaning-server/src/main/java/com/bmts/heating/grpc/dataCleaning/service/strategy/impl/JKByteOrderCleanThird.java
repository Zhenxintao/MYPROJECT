 ...
 */
@Component
@Clean(cleanType = DataCleanType.BYTE_ORDER_LITTLE_TO_SWAP)
public class JKByteOrderCleanThird implements DataCleanStrategy<PointL> {
    ...
    public PointL dataClean(PointL pointL) {
        ...
        if (!StringUtils.isEmpty(oldStr) && !Objects.equals("\"\"", oldStr)) {
            ...
            String newStr = ByteOrderUtil.littleToSwap(oldStr);
