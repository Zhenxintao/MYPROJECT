package com.bmts.heating.web.auth.utils;
...
//            conn.setRequestProperty("user-agent", "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1;SV1)");
    ...
    public static String reloadGet(String url,Map<String,String> map) {
        StringBuffer sbf = new StringBuffer();
        HttpURLConnection conn = null;
        BufferedReader br = null;
        String content = null;
        try {
            ...
            conn.setRequestProperty("accept", "*/*");
            conn.setRequestProperty("connection", "Keep-Alive");
            conn.setRequestProperty("access_token", map.get("access_token"));
            conn.setRequestProperty("refresh_token", map.get("refresh_token"));
            if (conn.getResponseCode() == 200) {
                br = new BufferedReader(new InputStreamReader(conn.getInputStream(), "utf-8"));
                while ((content = br.readLine()) != null) {
                    sbf.append(content);
